...
test<-ggplot(xx, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
...
bp1 <- ggplot(xx_group_1, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
...
bp2 <- ggplot(xx_group_2, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
...
bp3 <- ggplot(xx_group_3, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
...
bp4 <- ggplot(xx_group_4, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
...
bp5 <- ggplot(xx_group_5, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
...
bp6 <- ggplot(xx_group_6, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
...
bp7 <- ggplot(xx_group_7, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
...
bp8 <- ggplot(xx_group_8, aes(x=2, y=top_8, fill=speed_category))+geom_bar(width=1, stat="identity")+
  xlim(0.5, 2.5) +coord_polar(theta="y")+ 
  coord_polar(theta = "y")+
  scale_fill_manual(values = c("red", "blue"))+
labs(x=NULL, y=NULL)+
